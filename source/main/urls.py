...
from webapp.views import index_view, task_create_view, task_view, task_update_view, task_delete_view, bulk_delete_view
...
urlpatterns = [
    ...
    path('task/bulk_delete/', bulk_delete_view, name='bulk_delete'),
]